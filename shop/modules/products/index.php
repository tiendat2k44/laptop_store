            ...
            try {
                ...
                $productId = $db->insert(
                    "INSERT INTO products (shop_id, category_id, brand_id, name, slug, description, cpu, ram, storage, screen_size, graphics, weight, battery, os, price, sale_price, stock_quantity, status, featured, thumbnail, created_at, updated_at) 
                     VALUES (:shop_id, :category_id, :brand_id, :name, :slug, :desc, :cpu, :ram, :storage, :screen, :graphics, :weight, :battery, :os, :price, :sale, :stock, 'active', :featured, :thumb, NOW(), NOW())",
                    [
                        'shop_id' => $shopId,
                ...
                foreach ($galleryPaths as $imgPath) {
                    $db->insert(
                        ...
                        ['pid' => $productId, 'img' => $imgPath, 'ord' => $ord]
                    );
                    $ord++;
                }
...
<div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-box"></i> Sản phẩm của cửa hàng</h2>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6 d-flex align-items-end">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="featured" id="featuredShopAdd">
                                <label class="form-check-label" for="featuredShopAdd">Đánh dấu nổi bật</label>
                            </div>
                        </div>
